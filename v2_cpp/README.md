...
> **Note:** v2 is for showcase/demo only. Some CMake files and components are intentionally omitted. No commit history. 
...
Event-driven options engine: shared backtest/live core, Parquet history, IB gateway, FastAPI/Next.js UI.
...
**Status:** legacy / end-to-end usable  
**Stack:** Python, FastAPI, SQLite, Tradier, IB TWS  
**Linters:** mypy, ruff.

Original Python implementation, kept for reference.  

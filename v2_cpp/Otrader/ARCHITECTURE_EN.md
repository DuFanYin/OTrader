...
├── entry_live_grpc.cpp                 					#   Live + gRPC service entry (single live entry)
│
...
| **Live (gRPC)** | Market data from MarketDataEngine (e.g. Tradier); submit orders and record fills via IB TWS, and expose external control via gRPC | `entry_live_grpc` | EngineService at `0.0.0.0:50051`; contracts and orders/trades in PostgreSQL |

...
class PositionEngine : public utilities::BaseEngine {
  public:
    ...
    explicit PositionEngine(runtime_common::MainEngineBase* main)
        : BaseEngine(main, "Position") {}
    ...
    void process_trade_event(const std::string& strategy_name, const utilities::TradeData& trade);

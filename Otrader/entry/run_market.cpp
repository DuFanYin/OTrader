/**
 * Market Data mode: ZMQ REP+PUB fronting the Tradier MarketDataEngine + PostgreSQL contract
 * load. No gateway/IB dependency — part of the engine that builds without IBJts.
 */

#include "entry_modes.hpp"

#include "infra/db/engine_db_pg.hpp"
#include "infra/gateway/zmq_gateway_schema.hpp"    // ZmqRequest/ZmqResponse envelope (no IB)

...
event_engine.register(EVENT_OPTION_PORTFOLIO_COMPLETE, on_option_portfolio_complete)
...
try:
    ...
    main_engine.ib_gateway.query_portfolio("AAPL-USD-STK-SMART")

    # Wait for completion event (no timeout)
    while not option_portfolio_complete:

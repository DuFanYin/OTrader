...
public:
    ...
    ::grpc::Status ListStrategies(::grpc::ServerContext* context,
                                  const ::otrader::Empty* request,
                                  ::grpc::ServerWriter<::otrader::StrategySummary>* writer) override;

    // live 控制
    ::grpc::Status ConnectGateway(::grpc::ServerContext* context,
                                  const ::otrader::Empty* request,
    ...
    ::grpc::Status StartMarketData(::grpc::ServerContext* context,
                                   const ::otrader::Empty* request,
                                   ::otrader::Empty* response) override;

    ::grpc::Status StopMarketData(::grpc::ServerContext* context,
                                  const ::otrader::Empty* request,
                                  ::otrader::Empty* response) override;
    ...
    ::grpc::Status StreamStrategyUpdates(::grpc::ServerContext* context,
                                         const ::otrader::Empty* request,
    ...
    ::grpc::Status ListPortfolios(::grpc::ServerContext* context,
                                  const ::otrader::Empty* request,
